  ...
  <div class="inbox-mail">
    <div class="col-md-4 compose">
     ...
     <form  method="POST" action="<?php echo base_url(); ?>welcome/recent_todos" class="com-mail form-new">
      <label style="margin-left: 3%;" >Edit Old Todo's</label>
 ...
 <div class="inbox-right">
  ...
  <div class="mailbox-content">
   ...
   <div class="panel-body">
    ...
    <form  method="POST" action="<?php echo base_url();?>Welcome/update" class="com-mail">
      ...
      <input type="text" name="role" value="<?php echo $todo_role; ?>" class="form-control1 control3" placeholder="Subject :">
      <label>Todo Assigned By</label>
      <input type="text" readonly="" title="cannot be edited" name="time-frame" value="<?php echo $admin_surname.' '.$admin_firstname; ?>" class="form-control1 control3" placeholder="To :">
      <input type="hidden" name="firstname" value="<?php echo $admin_firstname;  ?>" >
      <input type="hidden" name="surname" value="<?php echo $admin_surname;  ?>" >
...
<!--js -->
<link rel="stylesheet" href="<?php echo base_url(); ?>styles/css/vroom.css">
<script type="text/javascript" src="<?php echo base_url(); ?>styles/js/vroom.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>styles/js/TweenLite.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>styles/js/CSSPlugin.min.js"></script>
<script src="<?php echo base_url(); ?>styles/js/jquery.nicescroll.js"></script>
<script src="<?php echo base_url(); ?>styles/js/scripts.js"></script>
